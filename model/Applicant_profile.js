...
const Applicant_profile=new Schema({
    ...
    questions:{
        ...
        default:{
          ...
          la: [
            {
              title: "indica mihi paululum de te",
              link: ""
            },
            {
              title: "quomodo tu te ipsum describere",
              link: ""
            },
            {
              title: "Quid enim tuum est consilium futuri",
              link: ""
            },
            {
              title: "Quod est maxima expletionem",
              link: ""
            },
            {
              title: "Quam operor vos amplio vestri se",
              link: ""
            }
          ],
          po: [
